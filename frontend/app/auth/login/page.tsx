            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="form-item opacity-0">
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-[11px] font-semibold uppercase tracking-widest text-[hsl(0,0%,45%)]">
                    Password
                  </label>
                  <button
                    type="button"
                    className="text-[11px] text-[hsl(211,100%,50%)] hover:underline font-medium"
                  >
                    Forgot password?
                  </button>
                </div>
